...
const projects: Project[] = [
  {
    id: 1,
    title: 'Event Dashboard Application',
    description:
      'A PHP-based dashboard application designed to manage and visualize event-related data with a clean interface and organized workflow.',
  ...
  },
  {
    ...
    description:
      'A MERN-based web application that visualizes live vehicle movement on an interactive map using real-time updates and modern frontend tools.',
  ...
  {
    id: 3,
    title: 'Movies Magic Chatbot',
    description:
      'A movie-based chatbot application built to provide interactive responses and improve user engagement through a conversational interface.',
  ...
  },
  {
    ...
    description:
      'A modern responsive personal portfolio website built with Next.js and Tailwind CSS to showcase projects, skills, and development journey.',
