...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col justify-center py-16 md:py-24 lg:py-32 relative"
    >
      {/* Decorative elements */}
      <div className="absolute top-40 right-0 w-40 h-40 bg-accent/5 rounded-full blur-3xl animate-pulse-slow opacity-70"></div>
      <div className="absolute bottom-20 left-10 w-60 h-60 bg-purple-500/5 rounded-full blur-3xl animate-pulse-slow opacity-70"></div>
      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-4 leading-tight">
              <span className="text-text">Hi, I&apos;m </span>
              <span className="gradient-text animate-gradient">Udit Bansal</span>
            </h1>
          </motion.div>
          ...
          >
            <p className="text-textLight mb-6 text-base lg:text-lg max-w-lg leading-relaxed">
              I build modern, responsive, and high-performance web applications with clean,
              maintainable code. Passionate about full stack development, problem-solving,
        ...
        >
          <div className="relative">
            ...
            <div className="relative w-60 h-60 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-full overflow-hidden border-4 border-accent/80 shadow-2xl shadow-accent/20 bg-secondary">
              <div className="relative w-full h-full">
                <Image
                  src="/images/profile.jpg"
                  alt="Udit Bansal - Profile Picture"
                  fill
                  className="object-cover object-top scale-135 transition-transform duration-500 hover:scale-140 filter saturate-[1.15]"
                  priority
                  onError={(e) => {
                    ;(e.target as HTMLImageElement).style.display = 'none'
                    ;(e.target as HTMLImageElement).nextElementSibling?.classList.remove('hidden')
