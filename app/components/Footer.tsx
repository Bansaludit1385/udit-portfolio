      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            ...
            <p className="text-textLight max-w-md">
              Computer Science student and software developer passionate about building impactful web applications and solving real-world problems.
            </p>
          </motion.div>
          ...
          >
            <div className="flex space-x-5 mb-4">
              {[
                { icon: <FaGithub size={22} />, href: "https://github.com/Bansaludit1385", label: "GitHub" },
                { icon: <FaLinkedin size={22} />, href: "https://www.linkedin.com/in/udit-bansal-8288ba294/", label: "LinkedIn" },
                { icon: <FaTwitter size={22} />, href: "https://x.com/UditBan52859684", label: "X / Twitter" },
                { icon: <FaEnvelope size={22} />, href: "mailto:budit1385@gmail.com", label: "Email" }
              ].map((social, index) => (
                <motion.a
                  key={index}
                  href={social.href}
            ...
            <motion.p
              ...
              transition={{ delay: 0.8, duration: 0.5 }}
            >
              © {currentYear} Udit Bansal. All rights reserved.
            </motion.p>
          </motion.div>
        </div>
