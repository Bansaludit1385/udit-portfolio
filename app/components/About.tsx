  ...
  return (
    <section id="about" className="py-20 scroll-mt-20 relative">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        >
          <motion.p variants={itemVariants} className="text-textLight mb-6 text-lg">
            Hello! I&apos;m <span className="text-accent font-medium">Udit Bansal</span>, a passionate developer who enjoys building practical, user-friendly, and responsive web applications while continuously improving problem-solving skills.
          </motion.p>
          
          <motion.p variants={itemVariants} className="text-textLight mb-6">
            My journey into programming started with curiosity about how websites and applications work behind the scenes. Over time, that curiosity turned into a strong interest in development, project building, and exploring modern web technologies.
          </motion.p>
          
          <motion.p variants={itemVariants} className="text-textLight mb-6">
            I believe in writing clean, maintainable code and learning by building real-world projects. I am focused on strengthening my development skills, improving my understanding of full-stack technologies, and creating projects that reflect practical learning.
          </motion.p>
          
          <motion.p variants={itemVariants} className="text-textLight">
            When I&apos;m not coding, I spend time exploring new technologies, working on personal projects, and sharpening my problem-solving mindset through continuous practice and learning.
          </motion.p>
